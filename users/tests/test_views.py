...
class RegisterViewTest(TestCase):
    def test_home_url_exists_at_desired_location(self):
        resp = self.client.get('/users/register/') # http://127.0.0.1:8000/users/register/ users/register/ users/register.html
...
class UserDetailViewTest(TestCase):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        login = self.client.login(email='test_user_detail@test.ru', password='test')
